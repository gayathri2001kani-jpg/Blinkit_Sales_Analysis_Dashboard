...
The project uses a **Galaxy Schema (Fact Constellation Schema)** consisting of multiple fact tables connected through shared dimension tables.
...
- **Item Dimension** – Contains item type, fat content, item attributes, and related information.
- **Outlet Dimension** – Contains outlet type, outlet size, location, and establishment information.
- **Date Dimension** – Contains date-based attributes used for time-series analysis.
